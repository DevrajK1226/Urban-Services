...
.info{
    ...
    <body>
        ...
        <h1 style="color: #fff; font-size:50px;">Electrical</h1><br>
            <img src="Images/electrician.jpg" class="img1"><br>
            <div class="info">
                <ul>
                    <li>Work with Safty</li>
                    <li>Clean & Safe</li>
        ...
        session_start();
            ...
            $sql="SELECT * FROM `bussiness_acc_data` WHERE `Bussiness`='electrical'";
