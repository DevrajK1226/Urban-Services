...
.info{
    ...
    <body>
        ...
        <h1 style="color: #fff; font-size:50px;">Carpentry</h1><br>
            <img src="Images/Carpentry.jpg" class="img1"><br>
            <div class="info">
                <ul>
                    <li>Profetional work</li>
                    <li>Clean & Safe</li>
        ...
        <?php
            ...
            $sql="SELECT * FROM `bussiness_acc_data` WHERE `Bussiness`='carpentry'";
