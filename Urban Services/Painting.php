...
.info{
    ...
    <body>
         ...
         <h1 style="color: #fff; font-size:50px;">Home Painting</h1><br>
            <img src="Images/home-painting.png" class="img1"><br>
            <div class="info">
               <ul>
                    <li>Level of putti</li>
                    <li>Clean & Safe</li>
                    <li>Water proof</li>
                </ul>
            </div>
        ...
        if(!session_start())
        {
            ...
            $sql="SELECT * FROM `bussiness_acc_data` WHERE `Bussiness`='Painting'";
            ...
            {echo "<div class='providers'>";
                ...
                <form method="post" class="frm" >
                    ...
                    <?php
                        ...
                        echo" Contact Me...        <div style='width:60px; height:60px;'><a href='https://wa.me/91$mobile_no[$i]'><img src='whatsapp.png' style='width:60px; height:60px;'></a>  </div>";
